...
final class RemoveStopsInRangeTest extends KernelTestCase
{
    ...
    private function removeStopsFromRangeDataProvider(): iterable
    {
        ...
        yield 'remove in PNL% range' => [
            [
                new Stop(1, 28710, 0.003, 10, $symbol, $side),
                new Stop(2, 28740, 0.003, 10, $symbol, $side),
                new Stop(3, 28760, 0.003, 10, $symbol, $side),
                new Stop(4, 28790, 0.003, 10, $symbol, $side),
                new Stop(5, 28810, 0.002, 10, $symbol, $side),
                new Stop(6, 28840, 0.004, 10, $symbol, $side),
                new Stop(7, 28860, 0.003, 10, $symbol, $side),
                new Stop(8, 28710, 0.003, 10, $symbol, $side),
                new Stop(9, 28890, 0.003, 10, $symbol, $side),
                new Stop(10, 28920, 0.003, 10, $symbol, $side),
            ],
