...
class HedgeTest extends TestCase
{
    ...
    public function isProfitableHedgeTestDataProvider(): array
    {
        return [
            [
                PositionFactory::short(Symbol::BTCUSDT, 100501, 0.1),
                PositionFactory::long(Symbol::BTCUSDT, 100500, 0.01),
                true
            ],
            [
                PositionFactory::short(Symbol::BTCUSDT, 100500, 0.1),
                PositionFactory::long(Symbol::BTCUSDT, 100500, 0.01),
                true
            ],
            [
                PositionFactory::short(Symbol::BTCUSDT, 100500, 0.1),
                PositionFactory::long(Symbol::BTCUSDT, 100501, 0.01),
                false
            ],
        ];
    }
