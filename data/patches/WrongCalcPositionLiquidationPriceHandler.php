 ...
 */
final class WrongCalcPositionLiquidationPriceHandler
{
    public function handle(Position $position, WalletBalance $contractWalletBalance): \App\Application\UseCase\Position\CalcPositionLiquidationPrice\CalcPositionLiquidationPriceResult
    {
        ...
        return new \App\Application\UseCase\Position\CalcPositionLiquidationPrice\CalcPositionLiquidationPriceResult(Price::float($position->entryPrice), $estimatedLiquidationPrice);
    }

    /**
     * @see https://www.bybit.com/en-US/help-center/article/Liquidation-Price-USDT-Contract
     */
    public function handleFromDocs(Position $position, WalletBalance $contractWalletBalance): \App\Application\UseCase\Position\CalcPositionLiquidationPrice\CalcPositionLiquidationPriceResult
    {
        ...
        return new \App\Application\UseCase\Position\CalcPositionLiquidationPrice\CalcPositionLiquidationPriceResult(Price::float($position->entryPrice), Price::float($liquidationPrice));
    }
}
