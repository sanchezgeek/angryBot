...
//            }
        ...
        $this->io->writeln(
            sprintf('For delete them just run:' . PHP_EOL . './bin/console sl:edit %s -aremove --filterCallbacks="getContext(\'uniqid\')===\'%s\'"', $positionSide->value, $uniqueId) . PHP_EOL . PHP_EOL
        );
