...
final readonly class CheckPassedLiquidationDistanceHandler
{
    ...
    private function getAlarmPassedDistance(Position $position, SymbolPrice $currentPrice): array
    {
        ...
        if ($override = SettingsHelper::exactForSymbolAndSideOrSymbol(AlarmSettings::PassedPart_Of_LiquidationDistance, $symbol, $side)) {
            return $override;
        }
        ...
        $threshold = SettingsHelper::exactForSymbolAndSideOrSymbol(AlarmSettings::PassedPart_Of_LiquidationDistance_Threshold_From_Allowed, $symbol, $side);
