...
final class SkipFurtherLiquidationCheckShortcutProcessor extends AbstractShortcutContextProcessor
{
    private const string KNOWN_CONTEXT = 'sFLc';
    ...
    protected function rawContextPart(string $shortcut, BuyOrder|Stop|OrderType $order): array
    {
        return [
            'checks' => [
                BuyOrder::SKIP_FURTHER_LIQUIDATION_CHECK_KEY => true
            ]
        ];
    }
